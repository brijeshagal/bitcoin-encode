...
//* User can only invest in tRBTC; Gives back all the assets and empties vault every 24 hours
contract CreditDelegationVault is ERC4626, Ownable {
    ...
    constructor(IERC20 _tRBTCToken) ERC4626(_tRBTCToken) ERC20("tRBTC Token", "tRBTC") Ownable(msg.sender) {
        investmentToken = _tRBTCToken;
