  ...
  return (
    ...
    >
      <div className="col-span-12 md:col-span-4 grid grid-cols-4 gap-y-6">
        ...
        <div className="flex flex-col  justify-center items-center col-span-2">
          <TextWithHint text="Assets" hint="Your Investment Value in GO" />
        ...
        <div className="col-span-2">
          <div className="mx-5">
            <Button
              text="Withdraw"
              onClick={() =>
                toast.info("Your Assets will reach your account automatically!")
              }
            />
          </div>
        </div>
...
export default PortfolioCardIntra;
